        ...
        <v-card>
            ...
            <v-container fluid grid-list-xl>
                <v-layout row wrap>
                    ...
                    <v-flex md3>
                        <v-text-field label="Телефон" mask="#(###) ###-##-##" v-model="editedItem.phoneNumber"></v-text-field>
                    </v-flex>
...
export default {
  ...
  computed: {
    ...
    sprDOCTYPs() {
			return this.$store.state.eais.stateHandbooks.sprDOCTYPs;
		},
  },
  methods: {
    extraFunk() {
