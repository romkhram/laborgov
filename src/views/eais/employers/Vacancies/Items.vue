...
<script>
import ItemsList from "Views/eais/employers/Vacancies/ItemsList";
...
export default {
  components: {
	...
	computed: {
		insideSearchName() {
			const insideSearchName = 'Список вакансий' + this.$store.state.eais.insideSearchName
			return insideSearchName;
		}
	},
	methods: {
