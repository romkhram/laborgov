...
export default {
  data() {
    return {
      items: [
				{ title: 'Подбор мест трудоустройства', path: 'info', exact: true },
  			{ title: 'Направления', path: 'directions', exact: true },
  			{ title: 'Справки', path: 'offer', exact: true },
  			{ title: 'Предложения', path: 'suggestions', exact: true },
  			{ title: 'Подтверждение', path: 'confirmation', exact: true }
			],
      settings: {
