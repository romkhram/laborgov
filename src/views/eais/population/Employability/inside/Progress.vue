            ...
            <v-card v-for="(item, index) in items" :key="item.index" class="eais__list mb-1 py-1">
                <v-container fluid py-3>
                    <v-layout row wrap>
				              ...
				              <v-flex md1>
				                <span class="body-1">М</span>
				              </v-flex>

				              <v-flex md3>
				                <span class="body-1" >С 12.12.2018 по 12.01.2019</span>
				              </v-flex>
				              ...
				              <v-flex md1>
				                <span class="body-1 ">51 чел</span>
				              </v-flex>

				              <v-flex md2  pr-4>
				                <span class="body-1" text-md-right> АЗН Колпинского района</span>
				              </v-flex>
