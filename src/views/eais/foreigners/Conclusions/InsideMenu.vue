...
export default {
  data() {
    return {
      items: [
				// { title: 'Профессии', path: 'professions', exact: true },
  				{ title: 'Реквизиты', path: 'requisites', exact: true },
    			// { title: 'Список', path: 'list', exact: true },
    			// { title: 'Квоты', path: 'quotas', exact: true },
    			// { title: 'Статистика', path: 'statistics', exact: true },
			],
      settings: {
