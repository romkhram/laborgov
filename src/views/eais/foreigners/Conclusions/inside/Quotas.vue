...
<div>
            ...
            <v-card v-for="(item, index) in items" :key="item.index" class="eais__list mb-1 py-1">
                <v-container fluid py-3>
                    <v-layout row wrap>
                        ...
                        <v-flex md1>
                            <span class="body-1">От 06.02.2018</span>
                        </v-flex>
                        ...
                        <v-flex md2>
                            <span class="body-1">
                              Квота - {{item.data.vacNum}}
                            </span>
                        </v-flex>

                        <v-flex md3>
                          <span class="body-1">
														Кол-во - {{item.data.vacNum}}
													</span>
                        </v-flex>
    ...
    <v-dialog v-model="editNewDialog" max-width="1100">
        <v-card>
            <v-card-title class="headline">Квота</v-card-title>
            ...
            <v-container fluid grid-list-xl>
                <v-layout row wrap>
                    ...
                    <v-flex md6 my-3 pr-5 class="multiflex">
                      <span class="editLabel">Квота</span>
                      <v-layout row wrap>
                    ...
                    <v-flex md6 my-3 class="multiflex">
                      <span class="editLabel">Срок</span>
                      <v-layout row wrap>
